...
def run():
    ...
    require('PARTICLE_COUNT_DESKTOP' in JS, "Desktop particle density control is missing")
    require('PARTICLE_COUNT_MOBILE' in JS, "Mobile particle density control is missing")
