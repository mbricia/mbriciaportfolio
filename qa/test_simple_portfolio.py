...
def run():
    ...
    require('PARTICLE_COUNT_DESKTOP = 260' in JS, "Desktop particle field should be balanced at 260 particles")
    require('PARTICLE_COUNT_MOBILE = 116' in JS, "Mobile particle field should stay lighter than desktop")
    require('alpha: 0.07 + Math.random() * 0.16' in JS, "Particle base opacity should stay subtle but visible")
    require('highlight: Math.random() < 0.12' in JS, "Particle field should include a small brighter depth layer")
    require('opacity:.62' in CSS, "Desktop particle canvas should be visible through the glass UI")
