...
def run():
    ...
    require('PARTICLE_COUNT_DESKTOP = 220' in JS, "Desktop particle field should be denser")
    require('PARTICLE_COUNT_MOBILE = 100' in JS, "Mobile particle field should be denser without matching desktop density")
    require('alpha: 0.05 + Math.random() * 0.16' in JS, "Particle opacity should stay subtle despite higher density")
